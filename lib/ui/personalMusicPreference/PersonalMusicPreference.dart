...
class PersonalMusicPreference extends StatefulWidget {
  const PersonalMusicPreference({Key? key}) : super(key: key);

  @override
  _PersonalMusicPreferenceState createState() => _PersonalMusicPreferenceState();
}

class _PersonalMusicPreferenceState extends State<PersonalMusicPreference> {
  ...
  initializeValues(){
    var vItems = personalDataModel!.language;
    if (vItems != null) {
    ...
    var vGenreItems = personalDataModel!.musicGenre;
    if (vGenreItems != null) {
      ...
      onPressed: () {
        if(validate()){
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => UploadMusicScreen(
  ...
  populateSelectedData(){
    ...
    if(personalDataModel != null){
      personalDataModel!.musicGenre = _selectedMusic.toString();
      personalDataModel!.language = _resultList.toString();
